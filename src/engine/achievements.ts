...
const DEFINITIONS: Def[] = [
  ...
  def("first_hiking",          "🥾", "Trail Blazer",        "Log your first Hiking session",                           "bronze", "workout"),
  ...
  def("first_drum",            "🥁", "First Beat",          "Log your first Drum Practice session",                    "bronze", "music"),
  def("first_piano",           "🎹", "First Keys",          "Log your first Piano Practice session",                   "bronze", "music"),
  def("first_music_theory",    "🎵", "The Theory",          "Log your first Music Theory session",                     "bronze", "music"),
  ...
  def("first_learning",        "📝", "Student Mindset",     "Log your first Learning session",                         "bronze"),
...
export function computeAchievements(
  ...
  const unlockedAt: Record<string, string | undefined> = {
    ...
    first_hiking:           check("first_hiking",           countActivity(entries, "hiking") >= 1),
    ...
    first_drum:             check("first_drum",             countActivity(entries, "drum_practice") >= 1),
    first_piano:            check("first_piano",            countActivity(entries, "piano_practice") >= 1),
    first_music_theory:     check("first_music_theory",     countActivity(entries, "music_theory") >= 1),
    ...
    first_learning:         check("first_learning",         countActivity(entries, "learning_general") >= 1),
